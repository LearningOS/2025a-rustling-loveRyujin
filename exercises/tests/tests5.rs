...
unsafe fn modify_by_address(address: usize) {
    // SAFETY: We are converting the provided address to a mutable pointer
    // and dereferencing it. This is safe because the function contract
    // guarantees that the address contains a valid mutable reference to a u32.
    unsafe {
